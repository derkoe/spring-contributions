...
/**
 * This is the spring annotation configuration class for the unit test {@link AnnotationMappedContributionIntegrationTest}
 * 
...
public abstract class MappedContributionIntegrationTestConfiguration
{
	...
	@ContributionMapped(bean="integerStrategy", to="strategies", keyClass=java.lang.Integer.class)
